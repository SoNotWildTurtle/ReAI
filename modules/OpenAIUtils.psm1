...
function Invoke-GPT {
    ...
    while ($attempt -lt $MaxRetries) {
        ...
        try {
            ...
            if (Get-Command Validate-GPTResponse -ErrorAction SilentlyContinue) {
                if (-not (Validate-GPTResponse -Response $response)) {
                    Write-Warning 'Invalid response structure. Possible spoofing attempt.'
                    return $null
                }
            }
