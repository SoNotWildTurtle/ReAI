...
function Show-ReAIMenu {
    ...
    $sections = @(
        @{Title='Service Tasks'; Items=@(
            ...
            @{Name='Register Startup'; Action={Register-ReAIStartup}; Description='Open log view when user logs in'},
            @{Name='Unregister Startup'; Action={Unregister-ReAIStartup}; Description='Remove startup log task'}
        )},
