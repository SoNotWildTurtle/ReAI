...
function Show-ReAIMenu {
    $sections = @(
        @{Title='Service Tasks'; Items=@(
            ...
            @{Name='Open Terminal'; Action={Open-ReAITerminal}; Description='Open a separate log terminal'},
            @{Name='Close Terminal'; Action={Close-ReAITerminal}; Description='Close the log terminal if open'}
        )},
