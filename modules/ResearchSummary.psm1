function Invoke-Research {
    ...
    $bizPlan = Generate-BusinessPlan -Topic $Topic -ResearchSummary $labReport
    $advisory = Generate-BusinessAdvisory -Topic $Topic -BusinessPlan $bizPlan
    ...
    $advisoryPath = Join-Path $global:ReportsDir "${base}_biz_advisory.md"
    ...
    Set-Content $advisoryPath $advisory
    ...
    Protect-File -Path $advisoryPath | Out-Null
    ...
    Write-Host "Saved business advisory to $advisoryPath" -ForegroundColor Green
