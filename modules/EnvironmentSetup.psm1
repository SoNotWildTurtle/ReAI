function Prompt-EnvVariables {
    ...
    if ([string]::IsNullOrWhiteSpace($env:OPENAI_RATE_LIMIT) -and
        [string]::IsNullOrWhiteSpace($env:OPENAI_MAX_RPM)) {
        $env:OPENAI_RATE_LIMIT = '30'
        [Environment]::SetEnvironmentVariable('OPENAI_RATE_LIMIT', '30', 'Process')
    }
}
